...
describe('files plugin helper functions', () => {
	...
	it('should ls a file list correctly', () => {
		const siapathInputs = List([
			...
			{ filesize: 1317, siapath: 'memes/waddup.png', redundancy: 2.0, available: true, uploadprogress: 100 },
			{ filesize: 1337, siapath: 'memes/itsdatboi.mov', redundancy: 2.0, available: true, uploadprogress: 100 },
			{ filesize: 1337, siapath: 'memes/rares/lordkek.gif', redundancy: 2.0, available: true, uploadprogress: 100 },
		...
		const expectedOutputs = {
			'': List([
				{ size: readableFilesize(1331+1333), name: 'doggos', siapath: 'doggos/', redundancy: undefined, available: true, uploadprogress: 100, type: 'directory' },
				{ size: readableFilesize(1337+13117), name: 'folder', siapath: 'folder/', redundancy: undefined, available: true, uploadprogress: 100, type: 'directory' },
				{ size: readableFilesize(1317+1337+1337), name: 'memes', siapath: 'memes/', redundancy: undefined, available: true, uploadprogress: 100, type: 'directory' },
			...
			'memes/': List([
				...
				{ size: readableFilesize(1337), name: 'rares', siapath: 'memes/rares/', available: true, redundancy: undefined, uploadprogress: 100, type: 'directory' },
				{ size: readableFilesize(1317), name: 'waddup.png', siapath: 'memes/waddup.png', available: true, redundancy: 2.0, uploadprogress: 100, type: 'file' },
			]),
		}
