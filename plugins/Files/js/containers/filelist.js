...
import { setPath, deselectAll, selectFile, downloadFile, showDeleteDialog, showRenameDialog } from '../actions/files.js'
...
const mapDispatchToProps = (dispatch) => ({
	actions: bindActionCreators({ setPath, deselectAll, selectFile, showRenameDialog, downloadFile, showDeleteDialog }, dispatch),
})
