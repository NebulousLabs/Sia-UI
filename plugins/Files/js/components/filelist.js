	...
	return (
		<div className="file-list">
			...
			<ul>
				...
				{ fileElements.size > 0 ? fileElements : <h2> No files uploaded. <span className="warning-text">Always backup uploaded files. SIA is not yet production ready. </span></h2> }
			</ul>
