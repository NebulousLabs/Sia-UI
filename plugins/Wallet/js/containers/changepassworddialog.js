...
import { hideChangePasswordDialog, changePassword, setChangePasswordError } from '../actions/wallet.js'

const mapStateToProps = (state) => ({
	changePasswordError: state.wallet.get('changePasswordError'),
})
const mapDispatchToProps = (dispatch) => ({
	actions: bindActionCreators({ hideChangePasswordDialog, changePassword, setChangePasswordError}, dispatch),
})
