...
const Wallet = ({confirmedbalance, unconfirmedbalance, siafundbalance, showReceivePrompt, showSendPrompt, showNewWalletDialog }) => (
...
Wallet.propTypes = {
	...
	siafunds: PropTypes.string.isRequired,
