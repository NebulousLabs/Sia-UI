...
import { addCommand, updateCommand, endCommand, hideSeedPrompt, hideCommandOverview } from '../actions/commandline.js'
...
const mapDispatchToProps = (dispatch) => ({
	actions: bindActionCreators({ addCommand, updateCommand, endCommand, hideSeedPrompt, hideCommandOverview }, dispatch),
})
